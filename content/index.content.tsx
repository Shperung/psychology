            ...
            <div className={styles.left_border}>
              ...
              <p>
                <Trans lang={lang}>
                  ...
                  грусті, провини, образи, невпевненості в собі, злості, ревнощів, ненависті, алк.
                  та тютюнової залежностей, токсичних стосунків, психосоматичних розладів,
                  депресивних станів, кризових сімейних станів.
                </Trans>
              </p>
            </div>
            <div className={styles.prof_blocks}>
